...
<div class="container">
    <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
        ...
        <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
            <li><a href="schedule-admin.php" class="nav-link px-2 link-secondary" style="color: black">Schedule</a></li>
            <li><a href="transaction-admin.php" class="nav-link px-2 link-dark" style="color: #6c757d">Transaction Summary</a></li>
        </ul>
...
<div class="container">
    ...
    <h5 style="margin-bottom: 20px;">until <?php echo $today ?></h5>
        ...
        <button class="w-10 btn btn-lg btn-primary" type="submit" style="margin-left: 15px;">Filter</button>
        <a href="javascript:window.history.go(-1);"><button class="w-10 btn btn-lg btn-primary" type="button" style="margin-left: 15px;">Back</button></a>
        </div>
		</form>
        </main>
