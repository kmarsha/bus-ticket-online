...
<body>
    <main class="form-signin">
        <form method="POST" action="add-admin-to.php">
            ...
            <button class="w-100 btn btn-lg btn-primary" type="submit">Add New-Admin</button>
            <p class="mt-5 mv-3 text-muted">Are you wanna add New Owner? <a href="add-owner.php">Please click here</a></p>
